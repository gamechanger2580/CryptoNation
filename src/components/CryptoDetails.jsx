...
const CryptoDetails = () => {
  ...
  const {data , isFetching} = useGetCryptoDetailsQuery({coinId: coinId, timeperiod: timePeriod});
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <LineChart  currentPrice = {millify(data?.data?.coin.price)} coinName={data?.data?.coin.name} coinHistory={coinHistory}/>
      ...
      <Col className='coin-desc-link'>
            <Row className='coin-desc'>
                <Title level={3} className='coin-details-heading'>
                  ...
                  <p style={{color: "black"}}>{data?.data?.coin.description}</p>
                </Title>
            ...
            <Col className='coin-links'>
              <Title level={3} className='coin-details-heading'>
                <Title level={4} className='coin-details-heading'>Websites to buy from: </Title>
